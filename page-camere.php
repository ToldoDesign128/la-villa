...
<main class="camere">
    ...
    <section class="camere__hero">
        ...
        <div class="camere__hero__image">
            <img src="<?php echo get_template_directory_uri() . '/assets/image/foto/camere/foto_camere (9).jpg'; ?>" alt="">
        </div>
    </section>
        ...
        <div class="container camere__poster__container">
            <div class="row camere__poster__container__block">
                ...
                <div class="camere__poster__container__block__image">
                    <img src="<?php echo get_template_directory_uri() . '/assets/image/foto/camere/foto_camere (2).jpg'; ?>" alt="">
                </div>
            </div>
        </div>
    </section>
